...
export default function MembersCardsCarousel2() {
  return (
    <Swiper
      ...
      className="MembersCard2-slider customSwiper membersCardSlider membersCardSliderCircle"
    >
        ...
        <SwiperSlide key={index} className="item">
            <div className="card mb-0">
              <div className="card-body">
                    <figure>
                        <Image fill src="/images/profile-bg.jpg" alt="img" className="img-fluid" />
                    </figure>
