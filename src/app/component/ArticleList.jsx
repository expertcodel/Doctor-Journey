...
export default function ArticleList({ articleCard, totalItems }) {


    const [button, setButton] = useState(totalItems);
    const [idx, setIdx] = useState(1);
    const [articleLists, setarticleLists] = useState(articleCard);
            ...
            <section className="sectionSpace sptb bg-white">
                <div className="container">
                    ...
                    <div className="row g-md-4 g-3">
                        {articleLists.map((card) => (
                            <div className="col-md-4 col-12 drCard" key={card.articleId}>
                                <div className="card mb-0">
                                    <div className="item7-card-img">
                                        <Link href={`/articles/${card.articleId}`} />
                                    ...
                                    <div className="card-body">
                                        <div className="item7-card-desc d-flex">
                                            <Link href={`/articles/${card.articleId}`} className="text-dark">
                                            <h4 className="font-weight-semibold">{card.articleTitle.substr(0,25)}{card.articleTitle.length > 25 && '...'}</h4>
                                        </Link>
                                        ...
                                        <p>&#8377;{card.price}</p>
                                        <div className="item7-card-desc d-flex">
                                            <span>{card.articleTitle.substr(0,30)}{card.articleTitle.length > 30 && '...'}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
