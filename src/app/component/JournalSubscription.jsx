...
export default function JournalSubscription({ subscriptionList, subscriptiondetail }) {
    ...
    return (
        <>
            {/*Breadcrumb*/}
            <Breadcrumb title="Journal Subscription" />
                        ...
                        <div className="col-xl-9 col-lg-12 col-md-12">
                            <div className="card mb-0">
                                <div className="card-header">
                                    <h3 className="card-title">Journal Subscription</h3>
                                </div>
                                <div className="card-body">
                                    <div className="row g-3">

                                        {subscriptiondetail.plans && subscriptiondetail.plans.plan1 && <div className="col-lg-4 col-md-6 col-12" >
                                            <div className="pricingTable bg-white advance-pricing">
                                                <div className="price-value">
                                                    &#8377;{subscriptiondetail.plans.plan1.price}
                                                    <span className="month">{subscriptiondetail.plans.plan1.plan}</span>
                                                </div>
                                                <h3 className="title">{subscriptiondetail.plans.plan1.detail}</h3>
                                        ...
                                        {subscriptiondetail.plans && subscriptiondetail.plans.plan2 && <div className="col-lg-4 col-md-6 col-12" >
                                            <div className="pricingTable bg-white advance-pricing">
                                                <div className="price-value">
                                                    &#8377;{subscriptiondetail.plans.plan2.price}
                                                    <span className="month">{subscriptiondetail.plans.plan2.plan}</span>
                                                </div>
                                                <h3 className="title">{subscriptiondetail.plans.plan2.detail}</h3>
                                                {/* <ul className="pricing-content">
                                                    <li>
                                                        <strong>4</strong> Ads
                                                    </li>
                                        ...
                                        {subscriptiondetail.plans && subscriptiondetail.plans.plan3 && <div className="col-lg-4 col-md-6 col-12" >
                                            <div className="pricingTable bg-white advance-pricing">
                                                <div className="price-value">
                                                    &#8377;{subscriptiondetail.plans.plan3.price}
                                                    <span className="month">{subscriptiondetail.plans.plan3.plan}</span>
                                                </div>
                                                <h3 className="title">{subscriptiondetail.plans.plan3.duration}</h3>
                                                <ul className="pricing-content" dangerouslySetInnerHTML={{ __html: subscriptiondetail.plans.plan3.detail }}>
                                                    ...
                                                    <>
                                                        <tbody>
                                                            {subscriptionList.map((subscription) => <tr>
                                                                <td className="text-primary">{subscription.registration_number}</td>
                                                                <td>{subscription.journal_id}</td>
                                                                <td>{subscription.journal_name}</td>
                                                                <td>{subscription.formattedDate}</td>
                                                                <td className="font-weight-semibold fs-16">&#8377;{subscription.amount}</td>

                                                                <td>
                                                                    <span className={subscription.is_paid ? "badge bg-success" : "badge bg-danger"}>
                                                                        {subscription.is_paid ? "Active" : "Expired"}
                                                                    </span>
                                                                </td>
                                                            </tr>)}
