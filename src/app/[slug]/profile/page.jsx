...
export default function Page() {
  ...
  //               <img src={userData?.profile_img} alt="user-img" className="img-thumbnail rounded-circle" />
  //             </div>
  //           </div>
  //           {/*end col*/}
  //           <div className="col">
  //             <div className="p-2">
  //               <h3 className="text-white mb-1">{userData?.name?.toUpperCase()}</h3>
  //               <p className="text-white text-opacity-75">{userData?.usertype?.toUpperCase()}</p>
  //               <div className="hstack text-white-50 gap-1">
  //                 <div className="me-2"><i className="ri-map-pin-user-line me-1 text-white text-opacity-75 fs-16 align-middle" />California, United States</div>
  //                 <div>
  //                   <i className="ri-building-line me-1 text-white text-opacity-75 fs-16 align-middle" />Themesbrand
  //                 </div>
  //               </div>
  //             </div>
  //           </div>
  ...
  //                   <a className="nav-link fs-14 active" data-bs-toggle="tab" href="#overview-tab" role="tab" aria-selected="true">
  //                     <i className="ri-airplay-fill d-inline-block d-md-none" /> <span className="d-none d-md-inline-block">Overview</span>
  //                   </a>
  //                 </li>
  //                 <li className="nav-item" role="presentation">
  //                   <a className="nav-link fs-14" data-bs-toggle="tab" href="#activities" role="tab" aria-selected="false" tabIndex={-1}>
  //                     <i className="ri-list-unordered d-inline-block d-md-none" /> <span className="d-none d-md-inline-block">Activities</span>
  //                   </a>
  //                 </li>
  //                 <li className="nav-item" role="presentation">
  //                   <a className="nav-link fs-14" data-bs-toggle="tab" href="#projects" role="tab" aria-selected="false" tabIndex={-1}>
  //                     <i className="ri-price-tag-line d-inline-block d-md-none" /> <span className="d-none d-md-inline-block">Projects</span>
  //                   </a>
  //                 </li>
  //                 <li className="nav-item" role="presentation">
  //                   <a className="nav-link fs-14" data-bs-toggle="tab" href="#documents" role="tab" aria-selected="false" tabIndex={-1}>
  ...
  //                                 <td className="text-muted">{userData?.mobile_number}</td>
  //                               </tr>
  //                               <tr>
  ...
  //                                 <td className="text-muted">{userData?.joining_date}</td>
  //                               </tr>
  //                             </tbody>
  //                           </table>
  //                         </div>
  ...
  //                               <img src="/assets/images/users/avatar-3.jpg" alt="" className="img-fluid rounded-circle material-shadow" />
  //                             </div>
  //                             <div className="flex-grow-1">
  //                               <div>
  ...
  //                               <button type="button" className="btn btn-sm btn-outline-success material-shadow-none"><i className="ri-user-add-line align-middle" /></button>
  //                             </div>
  //                           </div>
  //                           <div className="d-flex align-items-center py-3">
  //                             <div className="avatar-xs flex-shrink-0 me-3">
  //                               <img src="/assets/images/users/avatar-4.jpg" alt="" className="img-fluid rounded-circle material-shadow" />
  //                             </div>
  //                             <div className="flex-grow-1">
  //                               <div>
  ...
  //                           <div className="d-flex align-items-center py-3">
  //                             <div className="avatar-xs flex-shrink-0 me-3">
  //                               <img src="/assets/images/users/avatar-5.jpg" alt="" className="img-fluid rounded-circle material-shadow" />
  //                             </div>
  //                             <div className="flex-grow-1">
  //                               <div>
  ...
  //                           <div className="flex-shrink-0">
  //                             <img src="/assets/images/small/img-4.jpg" alt="" height={50} className="rounded material-shadow" />
  //                           </div>
  ...
  //                         <div className="d-flex mb-4">
  //                           <div className="flex-shrink-0">
  //                             <img src="/assets/images/small/img-5.jpg" alt="" height={50} className="rounded material-shadow" />
  //                           </div>
  //                           <div className="flex-grow-1 ms-3 overflow-hidden">
  //                             <a href="javascript:void(0);">
  ...
  //                           <div className="flex-shrink-0">
  //                             <img src="/assets/images/small/img-6.jpg" alt="" height={50} className="rounded material-shadow" />
  //                           </div>
  //                           <div className="flex-grow-1 ms-3 overflow-hidden">
  //                             <a href="javascript:void(0);">
  ...
  //                                 <li className="nav-item" role="presentation">
  //                                   <a className="nav-link active" data-bs-toggle="tab" href="#today" role="tab" aria-selected="true">
  //                                     Today
  //                                   </a>
  //                                 </li>
  //                                 <li className="nav-item" role="presentation">
  //                                   <a className="nav-link" data-bs-toggle="tab" href="#weekly" role="tab" aria-selected="false" tabIndex={-1}>
  //                                     Weekly
  //                                   </a>
  //                                 </li>
  //                                 <li className="nav-item" role="presentation">
  //                                   <a className="nav-link" data-bs-toggle="tab" href="#monthly" role="tab" aria-selected="false" tabIndex={-1}>
  //                                     Monthly
  //                                   </a>
  //                                 </li>
  //                               </ul>
  ...
  //                                           <div className="d-flex">
  //                                             <div className="flex-shrink-0">
  //                                               <img src="/assets/images/users/avatar-2.jpg" alt="" className="avatar-xs rounded-circle material-shadow" />
  //                                             </div>
  ...
  //                                           <div className="d-flex">
  //                                             <div className="flex-shrink-0">
  //                                               <img src="/assets/images/users/avatar-5.jpg" alt="" className="avatar-xs rounded-circle material-shadow" />
  //                                             </div>
  //                                             <div className="flex-grow-1 ms-3">
  ...
  //                                           <div className="d-flex">
  //                                             <div className="flex-shrink-0">
  //                                               <img src="/assets/images/users/avatar-7.jpg" alt="" className="avatar-xs rounded-circle material-shadow" />
  //                                             </div>
  //                                             <div className="flex-grow-1 ms-3">
  //                                               <h6 className="fs-14 mb-1">
  //                                                 Lewis Arnold
  ...
  //                                               <img src="/assets/images/users/avatar-4.jpg" alt="" className="rounded-circle avatar-xs material-shadow" />
  //                                             </a>
  ...
  //                                               <img src="/assets/images/users/avatar-3.jpg" alt="" className="rounded-circle avatar-xs material-shadow" />
  //                                             </a>
  ...
  //                                           <div className="d-flex">
  //                                             <div className="flex-shrink-0">
  //                                               <img src="/assets/images/users/avatar-3.jpg" alt="" className="avatar-xs rounded-circle material-shadow" />
  //                                             </div>
  //                                             <div className="flex-grow-1 ms-3">
  //                                               <h6 className="fs-14 mb-1">
  //                                                 Joseph Parker
  ...
  //                                                 {/*end col*/}
  //                                                 <div className="col-3">
  //                                                   <img src="/assets/images/small/img-5.jpg" alt="" className="img-fluid rounded material-shadow" />
  //                                                 </div>
  //                                                 {/*end col*/}
  //                                                 <div className="col-3">
  //                                                   <img src="/assets/images/small/img-7.jpg" alt="" className="img-fluid rounded material-shadow" />
  //                                                 </div>
  //                                                 {/*end col*/}
  //                                                 <div className="col-3">
  //                                                   <img src="/assets/images/small/img-9.jpg" alt="" className="img-fluid rounded material-shadow" />
  //                                                 </div>
  //                                                 {/*end col*/}
  //                                               </div>
  //                                               {/*end row*/}
  ...
  //                                           <div className="d-flex">
  //                                             <div className="flex-shrink-0">
  //                                               <img src="/assets/images/users/avatar-6.jpg" alt="" className="avatar-xs rounded-circle material-shadow" />
  //                                             </div>
  //                                             <div className="flex-grow-1 ms-3">
  //                                               <h6 className="fs-14 mb-1">
  ...
  //                                             project.</p>
  //                                           <div className="avatar-group">
  //                                             <a href="javascript: void(0);" className="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title data-bs-original-title="Christi">
  //                                               <img src="/assets/images/users/avatar-4.jpg" alt="" className="rounded-circle avatar-xs" />
  //                                             </a>
  //                                             <a href="javascript: void(0);" className="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title data-bs-original-title="Frank Hook">
  //                                               <img src="/assets/images/users/avatar-3.jpg" alt="" className="rounded-circle avatar-xs" />
  //                                             </a>
  //                                             <a href="javascript: void(0);" className="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title data-bs-original-title=" Ruby">
  //                                               <div className="avatar-xs">
  ...
  //                                               </div>
  //                                             </a>
  //                                             <a href="javascript: void(0);" className="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title data-bs-original-title="more">
  //                                               <div className="avatar-xs">
  ...
  //                         {/* Swiper */}
  //                         <div className="swiper project-swiper mt-n4 swiper-initialized swiper-horizontal swiper-backface-hidden">
  //                           <div className="d-flex justify-content-end gap-2 mb-2">
  //                             <div className="slider-button-prev swiper-button-disabled" tabIndex={-1} role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-2a3f8f3b10337df29" aria-disabled="true">
  //                               <div className="avatar-title fs-18 rounded px-1 material-shadow">
  //                                 <i className="ri-arrow-left-s-line" />
  //                               </div>
  //                             </div>
  //                             <div className="slider-button-next" tabIndex={0} role="button" aria-label="Next slide" aria-controls="swiper-wrapper-2a3f8f3b10337df29" aria-disabled="false">
  //                               <div className="avatar-title fs-18 rounded px-1 material-shadow">
  //                                 <i className="ri-arrow-right-s-line" />
  //                               </div>
  //                             </div>
  //                           </div>
  //                           <div className="swiper-wrapper" id="swiper-wrapper-2a3f8f3b10337df29" aria-live="polite">
  //                             <div className="swiper-slide swiper-slide-active" role="group" aria-label="1 / 5" style={{width: '310.333px', marginRight: '25px'}}>
  ...
  //                             </div>
  //                             {/* end slide item */}
  //                             <div className="swiper-slide swiper-slide-next" role="group" aria-label="2 / 5" style={{width: '310.333px', marginRight: '25px'}}>
  ...
  //                               </div>{/* end card */}
  //                             </div>{/* end slide item */}
  //                             <div className="swiper-slide" role="group" aria-label="3 / 5" style={{width: '310.333px', marginRight: '25px'}}>
  //                               <div className="card profile-project-card shadow-none profile-project-info mb-0 material-shadow">
  //                                 <div className="card-body p-4">
  //                                   <div className="d-flex">
  //                                     <div className="flex-grow-1 text-muted overflow-hidden">
  //                                       <h5 className="fs-14 text-truncate mb-1">
  ...
  //                               </div>{/* end card */}
  //                             </div>{/* end slide item */}
  //                             <div className="swiper-slide" role="group" aria-label="4 / 5" style={{width: '310.333px', marginRight: '25px'}}>
  //                               <div className="card profile-project-card shadow-none profile-project-danger material-shadow mb-0">
  //                                 <div className="card-body p-4">
  //                                   <div className="d-flex">
  //                                     <div className="flex-grow-1 text-muted overflow-hidden">
  //                                       <h5 className="fs-14 text-truncate mb-1">
  ...
  //                             </div>
  //                             {/* end slide item */}
  //                             <div className="swiper-slide" role="group" aria-label="5 / 5" style={{width: '310.333px', marginRight: '25px'}}>
  //                               <div className="card profile-project-card shadow-none profile-project-warning material-shadow mb-0">
  //                                 <div className="card-body p-4"> 
  //                                   <div className="d-flex">
  //                                     <div className="flex-grow-1 text-muted overflow-hidden">
  //                                       <h5 className="fs-14 text-truncate mb-1">
  ...
  //                           <p className="text-muted mb-2"><i className="ri-file-text-line align-middle ms-2" /> Create new project Buildng product</p>
  ...
  //                         <label htmlFor="formFile" className="btn btn-danger"><i className="ri-upload-2-fill me-1 align-bottom" /> Upload File</label>
  //                       </div>
  //                     </div>
  //                     <div className="row">
  //                       <div className="col-lg-12">
  ...
  //                                       <li><a className="dropdown-item" href="javascript:void(0);"><i className="ri-download-2-fill me-2 align-middle text-muted" />Download</a></li>
  //                                       <li className="dropdown-divider" />
  //                                       <li><a className="dropdown-item" href="javascript:void(0);"><i className="ri-delete-bin-5-line me-2 align-middle text-muted" />Delete</a></li>
  //                                     </ul>
  //                                   </div>
  //                                 </td>
  //                               </tr>
  ...
  //                                       <li><a className="dropdown-item" href="javascript:void(0);"><i className="ri-eye-fill me-2 align-middle" />View</a></li>
  //                                       <li>
  //                                         <a className="dropdown-item" href="javascript:void(0);"><i className="ri-download-2-fill me-2 align-middle" />Download</a>
  //                                       </li>
  ...
  //                                       <li><a className="dropdown-item" href="javascript:void(0);"><i className="ri-eye-fill me-2 align-middle" />View</a></li>
  //                                       <li><a className="dropdown-item" href="javascript:void(0);"><i className="ri-download-2-fill me-2 align-middle" />Download</a></li>
  //                                       <li>
  //                                         <a className="dropdown-item" href="javascript:void(0);"><i className="ri-delete-bin-5-line me-2 align-middle" />Delete</a>
  //                                       </li>
  //                                     </ul>
  //                                   </div>
  //                                 </td>
  ...
  //                           <a href="javascript:void(0);" className="text-success"><i className="mdi mdi-loading mdi-spin fs-20 align-middle me-2" /> Load more </a>
  //                         </div>
  //                       </div>
  //                     </div>
  //                   </div>
