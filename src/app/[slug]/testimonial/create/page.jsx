...
export default function Page() {
    ...
    const createTestimonials = async (e) => {
        ...
        if (flag) {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/superAdmin/testimonials`, {
                method: 'POST',
                body: formData
            })
                                ...
                                <div className="card-body">
                                    <form onSubmit={createTestimonials}>
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input type="text" className="form-control" id="menu-serial-input" placeholder="Enter designation" name='serial' style={{ border: formValidation.serial === 0 && '1px solid red' }} />
                                        </div>
