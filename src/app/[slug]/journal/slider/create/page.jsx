        ...
        if (flag) {
            ...
            try {
                ...
                const data={
                    ...
                    url,sliderSerial,sliderContent
                }
                ...
                const response=await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/superAdmin/slider/createSlider`,{
                    method:'POST',
                    body:formData
                })
            ...
            <div className="row">
                <div className="col-12">
                    <div className="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                        <h4 className="mb-sm-0">Create Slider</h4>
                        ...
                        <div className="card-body">
                            <form onSubmit={createSlider}>
                                <div className="mb-3">
                                    ...
                                    <input type="text" className="form-control" id="menu-title-input" placeholder="Enter slider url" name='url' style={{ border: formValidation.url === 0 && '1px solid red' }} />
                                </div>
                                
                                <div className="mb-3">
                                    <label className="form-label" htmlFor="menu-serial-input">Serial No.</label>
                                    <input type="number" className="form-control" id="menu-serial-input" placeholder="Enter Serial Number" name='serial' style={{ border: formValidation.sliderSerial === 0 && '1px solid red' }} />
                                </div>
                                ...
                                <div className="mb-3">
                                           ...
                                           {!success &&  <Image   priority width={imageUrl && 100} height={imageUrl && 100} id='imagePreview'/>}
                                            
                                        </div>

                                <div className="mb-3">
                                            <label className="form-label" htmlFor="destination Description">Slider Description</label>
                                            <textarea className="form-control" rows={4} placeholder='type...' name='description' id='destination Description' style={{ border: formValidation.sliderContent === 0 && '1px solid red' }} />
