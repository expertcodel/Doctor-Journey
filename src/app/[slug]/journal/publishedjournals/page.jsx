...
function Page() {
    ...
    useEffect(() => {
        ...
        const fetching = async () => {
            ...
            //console.log(response.data.publishedJournallist[0]);
            
            setJournallist(response.data.publishedJournallist);
            setSearchlist(response.data.publishedJournallist);
    ...
    const searchArticles = (e) => {
        ...
        setSearchlist((prev) => prev.filter((item) => item.journalTitle.toLowerCase().includes(e.target.value.toLowerCase())))

    }

    const handleJournal=(detail)=>{
        ...
        <div className="main-content">
            <div className="page-content">

                {
                                                    ...
                                                    <thead className="gridjs-thead">
                                                        <tr className="gridjs-tr">
                                                            ...
                                                            <th
                                                                ...
                                                                style={{ width: 180 }}
                                                            >
                                                                <div className="gridjs-th-content">Volume</div>
                                                            </th>
                                                            <th
                                                                ...
                                                                style={{ width: 120 }}
                                                            >
                                                                <div className="gridjs-th-content">Version</div>
                                                            </th>
                                                            <th
                    ...
                    <Journalpage journalDetail={journalDetail} setJournalpage={setJournalpage}/>
