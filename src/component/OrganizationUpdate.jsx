...
export default function OrganizationUpdate({ organizationDetail }) {
    ...
    const [location, setLocation] = useState(organizationDetail.location ? organizationDetail.location : [{ latitude: "", longitude: "" }]);

    useEffect(() => {

        organizationDetail.document.forEach((url, i) => imgRef.current[i].src = url.documentFile);
    }, [])
    ...
    const createOrganization = async (e) => {
        ...
        e.preventDefault();
        const organizationName = e.target.name.value.trim();
        ...
        try {
            ...
            const data = {
                ...
                organizationName, specialization, qualification, email, number, shortDescription, address, location, experience, city, country, zip, branchAddress, branchName, bankName, ifsc, accountNumber, organizationId: organizationDetail.organizationId, document, gstNumber, accountType, accountName
            }
                                ...
                                <div className="card-body">
                                    <div className="d-flex align-items-center mb-5">
                                        <div className="flex-grow-1">
                                            <h5 className="card-title mb-0">Update Organization Profile</h5>
                                        </div>
                                                    ...
                                                    <div className="col-lg-6">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='name'
                                                                defaultValue={organizationDetail.organizationName}
                                                    ...
                                                    <div className="col-lg-6">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='number'
                                                                defaultValue={organizationDetail.number}
                                                            />
                                                        </div>
                                                    </div>
                                                    {/*end col*/}
                                                    ...
                                                    <div className="col-lg-4">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='specialization'
                                                                defaultValue={organizationDetail.specialization}
                                                    ...
                                                    <div className="col-lg-4">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='qualification'
                                                                defaultValue={organizationDetail.qualification}
                                                    ...
                                                    <div className="col-lg-4">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='experience'
                                                                defaultValue={organizationDetail.experience}
                                                    ...
                                                    <div className="col-lg-12">
                                                        <div className="mb-3 pb-2">
                                                            ...
                                                            <textarea
                                                                ...
                                                                name='description'
                                                                rows={3}
                                                                defaultValue={organizationDetail.shortDescription}
                                                    ...
                                                    <div className="col-lg-4">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                placeholder="City"
                                                                name='city'
                                                                defaultValue={organizationDetail.city}
                                                    ...
                                                    <div className="col-lg-4">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                placeholder="Country"
                                                                name='country'
                                                                defaultValue={organizationDetail.country}
                                                    ...
                                                    <div className="col-lg-4">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='zip'
                                                                defaultValue={organizationDetail.zip}
                                                    ...
                                                    <div className="col-lg-12">
                                                        <div className="mb-3 pb-2">
                                                            ...
                                                            <textarea
                                                                ...
                                                                rows={3}
                                                                name='address'
                                                                defaultValue={organizationDetail.address}
                                    ...
                                    <div className="col-lg-6" id='im2'>
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                name='degreeName'
                                                defaultValue={organizationDetail.degreeName}
                                    ...
                                    <div className="col-lg-6">
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                name='identityName'
                                                defaultValue={organizationDetail.identityName}
                                    ...
                                    <div className="col-lg-6">
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                name='license'
                                                defaultValue={organizationDetail.license}
                                                    ...
                                                    <div className="col-lg-6">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='accountNumber'
                                                                defaultValue={organizationDetail.accountNumber}
                                                    ...
                                                    <div className="col-lg-6">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='ifsc'
                                                                defaultValue={organizationDetail.ifsc}
                                                    ...
                                                    <div className="col-lg-4">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='accountName'
                                                                defaultValue={organizationDetail.accountName}
                                                    ...
                                                    <div className="col-lg-4">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='accountType'
                                                                defaultValue={organizationDetail.accountType}
                                                    ...
                                                    <div className="col-lg-4">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='gstNumber'
                                                                defaultValue={organizationDetail.gstNumber}
                                                    ...
                                                    <div className="col-lg-6">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='bankName'
                                                                defaultValue={organizationDetail.bankName}
                                                    ...
                                                    <div className="col-lg-6">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='branchName'
                                                                defaultValue={organizationDetail.branchName}
                                                    ...
                                                    <div className="col-lg-12">
                                                        <div className="mb-3 pb-2">
                                                            ...
                                                            <textarea
                                                                ...
                                                                name='branchAddress'
                                                                rows={3}
                                                                defaultValue={organizationDetail.branchAddress}
