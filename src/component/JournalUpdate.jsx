                        ...
                        <form className="row g-3" onSubmit={saveJournal}>
                            ...
                            <div className="col-md-4">
                                ...
                                <span className='d-block mt-2'>
                                    (ref. https://youtube.com/shorts/<b>lS6wqQMN-iA</b>?si=BcrfBUM-nadcvO6K)
                                </span>
                            </div>
                            <div className="col-md-4">
                                <label htmlFor="fullnameInput" className="form-label">
                            ...
                            <div className="col-md-8">
                                ...
                                <div className='row'>
                                    ...
                                    <div className='col-md-6 col-12'>
                                        {croppedUrl1 && (
                                            <div>
                                                <h4 className="text-lg font-medium">Cropped Preview:</h4>
                                ...
                                {image.length > 0 && image.map((item, i) => <div key={i} className="content-section">
                                    ...
                                    <div className='row'>
                                        <div className='col-md-6 col-12'>
                                            ...
                                            {item && <JournalDetailsSliderCropper imageSrc={item} onCrop={(blob) => handleCrop(blob, i)} />}
                                        </div>
