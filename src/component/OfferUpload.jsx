                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                <h4 className="mb-sm-0">Create Offers</h4>
                                ...
                                <div className="card-body">
                                    <form onSubmit={createOffer}>
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input type="text" className="form-control" id="menu-title-input" placeholder="Enter discount" name='discount' style={{ border: formValidation.discount === 0 && '1px solid red' }} />
                                        </div>



                                        {/* <div className="mb-3">
                                            <label className="form-label" htmlFor="category-input">Select Journals</label>
                                            ...
                                            <select name="doctor" className="form-control" style={{ border: formValidation.doctor === 0 && '1px solid red' }} >
                                                ...
                                                {
                                                    journalList.length > 0 && journalList.map((item) => <option value={JSON.stringify({ id: item.doctorId, name: item.doctorName, specialization: item.specialization })} key={item.doctorId}>{item.doctorName.toUpperCase()}</option>)
                                                }
