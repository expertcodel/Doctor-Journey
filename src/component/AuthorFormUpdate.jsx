...
export default function AuthorForm({ authorDetail }) {
    ...
    useEffect(() => {
        ...
        authorDetail.document.forEach((url, i) => imgRef.current[i].src = url.documentFile);
    }, [])
    ...
    const createAuthor = async (e) => {
        ...
        try {
            ...
            const data = {
                ...
                authorName, specialization, qualification, email, number, shortDescription, address, location, experience, city, country, zip, branchAddress, branchName, bankName, ifsc, accountNumber, authorId: authorDetail.authorId, document, gstNumber, accountType, accountName
            }
                                    ...
                                    <div className="col-lg-6">
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                name='name'
                                                defaultValue={authorDetail.authorName}
                                    ...
                                    <div className="col-lg-6">
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                name='number'
                                                defaultValue={authorDetail.number}
                                            />
                                        </div>
                                    </div>
                                    {/*end col*/}
                                    <div className="col-lg-6">
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                name='email'
                                                defaultValue={authorDetail.email}
                                    ...
                                    <div className="col-lg-4">
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                name='specialization'
                                                defaultValue={authorDetail.specialization}
                                    ...
                                    <div className="col-lg-4">
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                name='qualification'
                                                defaultValue={authorDetail.qualification}
                                    ...
                                    <div className="col-lg-4">
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                name='experience'
                                                defaultValue={authorDetail.experience}
                                    ...
                                    <div className="col-lg-12">
                                        <div className="mb-3 pb-2">
                                            ...
                                            <textarea
                                                ...
                                                name='description'
                                                rows={3}
                                                defaultValue={authorDetail.shortDescription}
                                    ...
                                    <div className="col-lg-4">
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                placeholder="City"
                                                name='city'
                                                defaultValue={authorDetail.city}
                                    ...
                                    <div className="col-lg-4">
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                placeholder="Country"
                                                name='country'
                                                defaultValue={authorDetail.country}
                                    ...
                                    <div className="col-lg-12">
                                        <div className="mb-3 pb-2">
                                            ...
                                            <textarea
                                                ...
                                                rows={3}
                                                name='address'
                                                defaultValue={authorDetail.address}
                                    ...
                                    <div className="col-lg-6" id='im2'>
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                name='degreeName'
                                                defaultValue={authorDetail.degreeName}
                                    ...
                                    <div className="col-lg-6">
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                name='identityName'
                                                defaultValue={authorDetail.identityName}
                                    ...
                                    <div className="col-lg-6">
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                name='license'
                                                defaultValue={authorDetail.license}
                                    ...
                                    <div className="col-lg-6">
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                name='accountNumber'
                                                defaultValue={authorDetail.accountNumber}
                                    ...
                                    <div className="col-lg-6">
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                name='ifsc'
                                                defaultValue={authorDetail.ifsc}
                                    ...
                                    <div className="col-lg-4">
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                name='accountName'
                                                defaultValue={authorDetail.accountName}
                                    ...
                                    <div className="col-lg-4">
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                name='accountType'
                                                defaultValue={authorDetail.accountType}
                                    ...
                                    <div className="col-lg-4">
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                name='gstNumber'
                                                defaultValue={authorDetail.gstNumber}
                                    ...
                                    <div className="col-lg-6">
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                name='bankName'
                                                defaultValue={authorDetail.bankName}
                                    ...
                                    <div className="col-lg-6">
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                name='branchName'
                                                defaultValue={authorDetail.branchName}
                                    ...
                                    <div className="col-lg-12">
                                        <div className="mb-3 pb-2">
                                            ...
                                            <textarea
                                                ...
                                                name='branchAddress'
                                                rows={3}
                                                defaultValue={authorDetail.branchAddress}
