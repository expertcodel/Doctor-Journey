...
export default function PublisherUpdate({ publisherDetail }) {
    ...
    const [location, setLocation] = useState(publisherDetail.location ? publisherDetail.location : [{ latitude: "", longitude: "" }]);

    useEffect(() => {

        publisherDetail.document.forEach((url, i) => imgRef.current[i].src = url.documentFile);
    }, [])
    ...
    const createPublisher = async (e) => {

        e.preventDefault();
        const publisherName = e.target.name.value.trim();
        ...
        try {
            ...
            const data = {
                ...
                publisherName, specialization, qualification, email, number, shortDescription, address, location, experience, city, country, zip, branchAddress, branchName, bankName, ifsc, accountNumber, publisherId: publisherDetail.publisherId, document, gstNumber, accountType, accountName
            }
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/superAdmin/publisher`, {
                method: 'PUT',
                body: formData
            })
                                ...
                                <div className="card-body">
                                    <div className="d-flex align-items-center mb-5">
                                        <div className="flex-grow-1">
                                            <h5 className="card-title mb-0">Update Publisher Profile</h5>
                                        </div>
                                                    ...
                                                    <div className="col-lg-6">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='name'
                                                                defaultValue={publisherDetail.publisherName}
                                                    ...
                                                    <div className="col-lg-6">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='number'
                                                                defaultValue={publisherDetail.number}
                                                            />
                                                        </div>
                                                    </div>
                                                    {/*end col*/}
                                                    <div className="col-lg-6">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='email'
                                                                defaultValue={publisherDetail.email}
                                                    ...
                                                    <div className="col-lg-4">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='specialization'
                                                                defaultValue={publisherDetail.specialization}
                                                    ...
                                                    <div className="col-lg-4">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='qualification'
                                                                defaultValue={publisherDetail.qualification}
                                                    ...
                                                    <div className="col-lg-4">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='experience'
                                                                defaultValue={publisherDetail.experience}
                                                    ...
                                                    <div className="col-lg-12">
                                                        <div className="mb-3 pb-2">
                                                            ...
                                                            <textarea
                                                                ...
                                                                name='description'
                                                                rows={3}
                                                                defaultValue={publisherDetail.shortDescription}
                                                    ...
                                                    <div className="col-lg-4">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                placeholder="City"
                                                                name='city'
                                                                defaultValue={publisherDetail.city}
                                                    ...
                                                    <div className="col-lg-4">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                placeholder="Country"
                                                                name='country'
                                                                defaultValue={publisherDetail.country}
                                                    ...
                                                    <div className="col-lg-4">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='zip'
                                                                defaultValue={publisherDetail.zip}
                                                    ...
                                                    <div className="col-lg-12">
                                                        <div className="mb-3 pb-2">
                                                            ...
                                                            <textarea
                                                                ...
                                                                rows={3}
                                                                name='address'
                                                                defaultValue={publisherDetail.address}
                                    ...
                                    <div className="col-lg-6" id='im2'>
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                name='degreeName'
                                                defaultValue={publisherDetail.degreeName}
                                    ...
                                    <div className="col-lg-6">
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                name='identityName'
                                                defaultValue={publisherDetail.identityName}
                                    ...
                                    <div className="col-lg-6">
                                        <div className="mb-3">
                                            ...
                                            <input
                                                ...
                                                name='license'
                                                defaultValue={publisherDetail.license}
                                                    ...
                                                    <div className="col-lg-6">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='accountNumber'
                                                                defaultValue={publisherDetail.accountNumber}
                                                    ...
                                                    <div className="col-lg-6">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='ifsc'
                                                                defaultValue={publisherDetail.ifsc}
                                                    ...
                                                    <div className="col-lg-4">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='accountName'
                                                                defaultValue={publisherDetail.accountName}
                                                    ...
                                                    <div className="col-lg-4">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='accountType'
                                                                defaultValue={publisherDetail.accountType}
                                                    ...
                                                    <div className="col-lg-4">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='gstNumber'
                                                                defaultValue={publisherDetail.gstNumber}
                                                    ...
                                                    <div className="col-lg-6">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='bankName'
                                                                defaultValue={publisherDetail.bankName}
                                                    ...
                                                    <div className="col-lg-6">
                                                        <div className="mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name='branchName'
                                                                defaultValue={publisherDetail.branchName}
                                                    ...
                                                    <div className="col-lg-12">
                                                        <div className="mb-3 pb-2">
                                                            ...
                                                            <textarea
                                                                ...
                                                                name='branchAddress'
                                                                rows={3}
                                                                defaultValue={publisherDetail.branchAddress}
