...
export default function Page({blogdata, Metadescriptions,Categorylist,Blogstatus,Blogstatus1,blogDescription}) {
    ...
    const editBlog = async (e) => {
        ...
        if (flag) {
            ...
            const data={
                blogTitle,blogDescription, blogContent,metaDescriptions:metadescriptions,metaKeywords,metaTitle,blogSerial,blogStatus:blogstatus,blogUrl,blogId:blogdata.blogId
            }
