...
export default function AuthorUpdate({ authorDetail }) {
    ...
    const [location, setLocation] = useState(authorDetail.location ? authorDetail.location : [{ latitude: "", longitude: "" }]);
    const [video, setVideo] = useState(authorDetail.videos ? authorDetail.videos : [{ url: "", videoImage: "" }]);
    const [success, setSuccess] = useState(false);
    const [errorMsg, setErrormsg] = useState("");
    const [imageUrl, setImageurl] = useState(null);
    const [formValidation, setFormvalidation] = useState({ authorName: -1, specialization: -1, qualification: -1, shortDescription: -1, address: -1, number: -1, email: -1, image: -1 })

    // useEffect(() => {



    //     document.getElementById("imagePreview").src = authorDetail.profileImage
    ...
    //     const authorName = e.target.name.value.trim();
    ...
    //     const authorContent = document.querySelector('.jodit-wysiwyg').innerHTML;
    ...
    //         setFormvalidation({ authorName: arr[0], specialization: arr[1], qualification: arr[2], shortDescription: arr[3], address: arr[4], number: arr[5], email: arr[6], image: arr[7] });
    ...
    //                 authorName, specialization, qualification, email, number, shortDescription, address, authorContent, location, video,authorId:authorDetail.authorId
    //             }
    ...
    //             const response = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/superAdmin/authors`, {
    //                 method: 'PUT',
    //                 body: formData
    //             })
            ...
            <div className="page-content">
                <div className="container-fluid">
                    ...
                    <div className="row">
                                ...
                                <div className="card-body">
                                    <div className="d-flex align-items-center mb-5">
                                        <div className="flex-grow-1">
                                            <h5 className="card-title mb-0">Update Author Profile</h5>
                                        </div>
                        ...
                        <AuthorFormUpdate authorDetail={authorDetail}/>
                    ...
                    {/* <div className="row">
                        <div className="col-12">
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                <h4 className="mb-sm-0">Update author Profile</h4>
                                ...
                                <div className="card-body">
                                    <form onSubmit={createauthor}>
                                        <div className="mb-3">
                                            ...
                                            <input type="text" className="form-control" id="author-name" placeholder="Enter author name" name='name' style={{ border: formValidation.authorName === 0 && '1px solid red' }} defaultValue={authorDetail.authorName} />
                                        </div>

                                        <div className="mb-3">
                                            <label className="form-label" htmlFor="specialization">Specialization</label>
                                            <input type="text" className="form-control" id="specialization" placeholder="Enter Specialization" name='specialization' style={{ border: formValidation.specialization === 0 && '1px solid red' }} defaultValue={authorDetail.specialization} />
                                        </div>

                                        <div className="mb-3">
                                            <label className="form-label" htmlFor="qualification">qualification</label>
                                            <input type="text" className="form-control" id="qualification" placeholder="Enter qualification" name='qualification' style={{ border: formValidation.qualification === 0 && '1px solid red' }} defaultValue={authorDetail.qualification} />
                                        </div>
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <textarea className="form-control" rows={4} placeholder='type...' name='description' id='short-description' style={{ border: formValidation.shortDescription === 0 && '1px solid red' }} defaultValue={authorDetail.shortDescription} />

                                        </div>

                                        <div className="mb-3">
                                            <label className="form-label" htmlFor="address">Address</label>
                                            <textarea className="form-control" rows={4} placeholder='type...' name='address' id='address' style={{ border: formValidation.address === 0 && '1px solid red' }} defaultValue={authorDetail.address} />

                                        </div>

                                        <div className="mb-3">
                                            <label className="form-label" >author's Content</label>
                                            <JoditEditor ref={editor} config={config} value={authorDetail.authorContent} />
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input type="email" className="form-control" id="email-id" placeholder="Enter email" name='email' style={{ border: formValidation.email === 0 && '1px solid red' }} defaultValue={authorDetail.email} />

                                        </div>

                                        <div className="mb-3">
                                            <label className="form-label" htmlFor="number-id">Mobile Number</label>
                                            <input type="text" className="form-control" id="number-id" placeholder="Enter mobile number" name='number' style={{ border: formValidation.number === 0 && '1px solid red' }} defaultValue={authorDetail.number} />
