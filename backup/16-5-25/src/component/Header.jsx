          ...
          <div className="d-flex align-items-center">
                  ...
                  <div className="row align-items-center">
                    ...
                    <div className="col-auto">
                      <span className="badge bg-warning-subtle text-warning fs-13">
                        <span className="cartitem-badge">5</span>
                        items
                      </span>
                    </div>
                  </div>
                </div>
                <div data-simplebar="init" style={{ maxHeight: 300 }}>
                  <div className="simplebar-wrapper" style={{ margin: 0 }}>
                    <div className="simplebar-height-auto-observer-wrapper">
                      <div className="simplebar-height-auto-observer" />
                    </div>
            ...
            <div className="dropdown ms-sm-3 header-item topbar-user">
              ...
              <div className="dropdown-menu dropdown-menu-end">
                ...
                <Link className="dropdown-item" href={`/${userData?.usertype}/profile`}>
                ...
                <a className="dropdown-item" href={`/${userData?.usertype}/profile`}>
