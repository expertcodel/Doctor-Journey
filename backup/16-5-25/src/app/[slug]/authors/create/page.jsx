...
export default function Page() {
    ...
    const [video, setVideo] = useState([{ url: "", videoImage: "" }]);
        ...
        if (flag) {
            ...
            try {
                ...
                const data = {
                    ...
                    authorName, specialization, qualification, email, number, shortDescription, address, authorContent, location, video
                }
                    ...
                    {/* <div className="row">
                        <div className="col-12">
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                <h4 className="mb-sm-0">Create author Profile</h4>
                                ...
                                <div className="card-body">
                                    <form onSubmit={createauthor}>
                                        <div className="mb-3">
                                            ...
                                            <input type="text" className="form-control" id="author-name" placeholder="Enter author name" name='name' style={{ border: formValidation.authorName === 0 && '1px solid red' }} />
                                        </div>

                                        <div className="mb-3">
                                            <label className="form-label" htmlFor="specialization">Specialization</label>
                                            <input type="text" className="form-control" id="specialization" placeholder="Enter Specialization" name='specialization' style={{ border: formValidation.specialization === 0 && '1px solid red' }} />
                                        </div>

                                        <div className="mb-3">
                                            <label className="form-label" htmlFor="qualification">qualification</label>
                                            <input type="text" className="form-control" id="qualification" placeholder="Enter qualification" name='qualification' style={{ border: formValidation.qualification === 0 && '1px solid red' }} />
                                        </div>
                                        ...
                                        <div className="mb-3" >
                                            {video.length > 0 && video.map((video, i) => <div key={i} className="content-section">
                                                ...
                                                <input className="form-control" id={`project-video-img${i}`} type="file" name='videoImage' accept="image/*" onChange={(e) => handleVideo(e, i)}  required={video.url!==""?true:false}/>
                                                <div style={{ marginTop: '10px' }}>Choose 1520 x 451 Dimension</div>
                                                <Image priority width={video.videoImage && 100} height={video.videoImage && 100} id={`imagePreview${i}`} alt='' style={{ marginTop: '10px' }} />
                                                <br />
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <textarea className="form-control" rows={4} placeholder='type...' name='description' id='short-description' style={{ border: formValidation.shortDescription === 0 && '1px solid red' }} />

                                        </div>

                                        <div className="mb-3">
                                            <label className="form-label" htmlFor="address">Address</label>
                                            <textarea className="form-control" rows={4} placeholder='type...' name='address' id='address' style={{ border: formValidation.address === 0 && '1px solid red' }} />
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input type="email" className="form-control" id="email-id" placeholder="Enter email" name='email' style={{ border: formValidation.email === 0 && '1px solid red' }} />

                                        </div>

                                        <div className="mb-3">
                                            <label className="form-label" htmlFor="number-id">Mobile Number</label>
                                            <input type="text" className="form-control" id="number-id" placeholder="Enter mobile number" name='number' style={{ border: formValidation.number === 0 && '1px solid red' }}/>
                                ...
                                <div className="card-body">
                                    <div className="d-flex align-items-center mb-5">
                                        <div className="flex-grow-1">
                                            <h5 className="card-title mb-0">Complete Author Profile</h5>
                                        </div>
