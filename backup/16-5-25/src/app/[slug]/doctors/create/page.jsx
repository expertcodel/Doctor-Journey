...
import DoctorForm from '@/component/DoctorForm.jsx'
        ...
        if (flag) {
            ...
            try {
                ...
                const data = {
                    ...
                    doctorName, specialization, qualification, email, number, shortDescription, address, doctorContent, location, video
                }
                    ...
                    {/* <div className="row">
                        <div className="col-12">
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                <h4 className="mb-sm-0">Create Doctor Profile</h4>
                                ...
                                <div className="card-body">
                                    <form onSubmit={createDoctor}>
                                        <div className="mb-3">
                                            ...
                                            <input type="text" className="form-control" id="doctor-name" placeholder="Enter doctor name" name='name' style={{ border: formValidation.doctorName === 0 && '1px solid red' }} />
                                        </div>
                                ...
                                <div className="card-body">
                                    <div className="d-flex align-items-center mb-5">
                                        <div className="flex-grow-1">
                                            <h5 className="card-title mb-0">Complete Doctor Profile</h5>
                                        </div>
